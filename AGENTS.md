...
- **Backend**: [Directus](https://directus.io/) als Headless CMS (gehostet unter `admin.theater-kleinraming.at`). Es dient als Single Source of Truth für alle dynamischen Inhalte.
